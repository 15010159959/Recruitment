...
NasShop.prototype = {
    ...
    newOrder: function(orderInfo) {
        ...
        if (orderInfo.name === "" || orderInfo.name === undefined)
            throw new Error("orderInfo missing name");
        if (orderInfo.phone === "" || orderInfo.phone === undefined)
            throw new Error("orderInfo missing model");
        if (orderInfo.email === "" || orderInfo.email === undefined)
            throw new Error("orderInfo missing email");
        if (orderInfo.msg === "" || orderInfo.msg === undefined)
        throw new Error("orderInfo missing msg");
        ...
        orderItem.name = orderInfo.name;
        orderItem.phone = orderInfo.phone;
        orderItem.email = orderInfo.email;
        orderItem.msg = orderInfo.msg;
